...
beautiful.init("/home/demi/.config/awesome/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "space", function () awful.util.spawn("rofi -combi-modi window,drun -show combi -modi combi -icon-theme 'Papirus-Dark' -show-icons") end,
